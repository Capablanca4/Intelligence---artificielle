...
void setfillstyle( int pattern, int color )
{
    ...
    unsigned short Slash[8]      = { static_cast<unsigned short>(~0xE0),
                                     static_cast<unsigned short>(~0xC1),
                                     static_cast<unsigned short>(~0x83),
                                     static_cast<unsigned short>( ~0x07),
                                     static_cast<unsigned short>(~0x0E),
                                     static_cast<unsigned short>(~0x1C),
                                     static_cast<unsigned short>(~0x38),
                                     static_cast<unsigned short>(~0x70 )};

    unsigned short BkSlash[8]    = { static_cast<unsigned short>(~0x07),
                                     static_cast<unsigned short>(~0x83),
                                     static_cast<unsigned short>(~0xC1),
                                     static_cast<unsigned short>(~0xE0),
                                     static_cast<unsigned short>(~0x70),
                                     static_cast<unsigned short>(~0x38),
                                     static_cast<unsigned short>(~0x1C),
                                     static_cast<unsigned short>(~0x0E )};

    unsigned short Interleave[8] = { static_cast<unsigned short>(~0xCC),
                                     static_cast<unsigned short>(~0x33),
                                     static_cast<unsigned short>(~0xCC),
                                     static_cast<unsigned short>(~0x33),
                                     static_cast<unsigned short>(~0xCC),
                                     static_cast<unsigned short>(~0x33),
                                     static_cast<unsigned short>(~0xCC),
    ...
    unsigned short WideDot[8]    = { static_cast<unsigned short>(~0x80),
                                     static_cast<unsigned short>(~0x00),
                                     static_cast<unsigned short>(~0x08),
                                     static_cast<unsigned short>(~0x00),
                                     static_cast<unsigned short>(~0x80),
                                     static_cast<unsigned short>(~0x00),
                                     static_cast<unsigned short>(~0x08),
                                     static_cast<unsigned short>(~0x00) };

    unsigned short CloseDot[8]   = { static_cast<unsigned short>(~0x88),
                                     static_cast<unsigned short>(~0x00),
                                     static_cast<unsigned short>(~0x22),
                                     static_cast<unsigned short>(~0x00),
                                     static_cast<unsigned short>(~0x88),
                                     static_cast<unsigned short>(~0x00),
                                     static_cast<unsigned short>(~0x22),
                                     static_cast<unsigned short>(~0x00) };
    HBITMAP hBitmap;
