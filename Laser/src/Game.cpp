...
Game::Game(int nbLigne,int nbColonne,int cote,int maxIter):
    ...
    d_boutonDemarrer{nbLigne*cote+100,nbColonne*cote-200,100,40,"Demarrer"},
...
void Game::test(){
    ...
    BlocLaser* mur= new BlocLaser{d_echiquier.coordVersPoint(1),d_echiquier.coordVersPoint(1),d_echiquier.taille()};
