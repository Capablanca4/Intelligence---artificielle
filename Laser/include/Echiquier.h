...
class Echiquier
{
    public:
        ...
        void moveLaser(Viewer& fenetre,const coord& nextCoord);
        ...
        void setCoordLaser(coord coord);

    private:
        int d_taille;
        coord d_emplacementLaser; /** emplacement du laser sur le dessin */
        int d_nbligne;
        int d_nbcolonne;
